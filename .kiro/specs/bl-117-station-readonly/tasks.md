...
- [x] 1. DTO request models and PlayerContext accessors
  - [x] 1.1 Create StationUpdateRequest DTO
  ...
  - [x] 1.2 Create StationCreateRequest DTO
  ...
  - [x] 1.3 Add FindMutableStation internal method to PlayerContext
...
- [x] 2. Create StationViewModel as disconnected edit buffer
  - [x] 2.1 Create StationViewModel class
...
- [x] 3. Create StationService with CRUD methods
  - [x] 3.1 Create StationService class
...
- [x] 5. Migrate FormStation to ReadOnly wrappers and service
...
- [x] 8. Add ViewModel property tests
  ...
  - [x] 8.4 Write property test: IsDirty detects StationBlueprintUUID change
  ...
  - [x] 8.6 Write property test: IsDirty detects StationType change
  ...
  - [x] 8.7 Write property test: IsDirty detects Hold change
...
- [x] 9. Add ViewModel unit tests
  - [x] 9.1 Write unit tests for StationViewModel
...
- [x] 10. Add Service property tests
  ...
  - [x] 10.3 Write property test: Service.Delete removes station
    - **Property 10: Service.Delete Removes Station**
    - [FsCheck.NUnit.Property(MaxTest = 25)]
    - **Validates: Requirements 13.1, 13.2**
- [x] 11. Add Service unit tests
  - [x] 11.1 Write unit tests for StationService
...
- [x] 12. Add mutation guard test
  - [x] 12.1 Write mutation guard test for Station
