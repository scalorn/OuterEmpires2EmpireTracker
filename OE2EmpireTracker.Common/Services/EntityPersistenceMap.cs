        ...
        private static EntityPersistenceEntry[] BuildEntries()
        {
            return new[]
            {
                new EntityPersistenceEntry(
                    ...
                    (ctx, id) => ctx.ColonyList.FirstOrDefault(c => c.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(Blueprint),
                    ...
                    (ctx, id) => ctx.BlueprintList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(Survey),
                    ...
                    (ctx, id) => ctx.SurveyList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    ...
                    (ctx, id) => ctx.PlayerProfileList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    ...
                    (ctx, id) => ctx.DeliveryRouteList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(DeliveryPlan),
                ...
                new EntityPersistenceEntry(
                    ...
                    (ctx, id) => ctx.ShipTemplateList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(Station),
                    ...
                    (ctx, id) => ctx.StationList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    ...
                    (ctx, id) => ctx.MarketListingList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    ...
                    (ctx, id) => ctx.MarketTransactionList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(PricingPlan),
                    ...
                    (ctx, id) => ctx.PricingPlanList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(BuildPlan),
                    ...
                    (ctx, id) => ctx.BuildPlanList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(StockPlan),
                    ...
                    (ctx, id) => ctx.StockPlanList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(StockProfile),
                    ...
                    (ctx, id) => ctx.StockProfileList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(SupplyChain),
                    ...
                    (ctx, id) => ctx.SupplyChainList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    ...
                    (ctx, id) => ctx.WarehouseOverflowRuleList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(Asteroid),
                    ...
                    (ctx, id) => ctx.AsteroidList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    ...
                    (ctx, id) => ctx.BankingTransactionList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(MailMessage),
                    ...
                    (ctx, id) => ctx.MailMessageList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    typeof(Faction),
                    ...
                    (ctx, id) => ctx.FactionList.FirstOrDefault(x => x.UUID == id)),
                new EntityPersistenceEntry(
                    ...
                    (ctx, id) => ctx.ExternalCharacterList.FirstOrDefault(x => x.UUID == id)),
            };
        }
