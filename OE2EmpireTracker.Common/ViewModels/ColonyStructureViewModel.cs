...
namespace OE2EmpireTracker.ViewModels
{
    ...
    public class ColonyStructureViewModel
    {
        ...
        public ReadOnlyBlueprint Blueprint => _playerContext.FindBlueprint(_structure.FlatpackBlueprintUUID);
        ...
        public void MoveUp(Colony colony)
        {
            ...
            {
                Log.Info(
                    "MoveUp: blocked â€” already at top (seq={0}), structure={1}",
                    mySeq,
                    _structure.UUID);
                return;
            }
            ...
            {
                Log.Info(
                    "MoveUp: blocked â€” cannot move above CC, structure={0} seq={1}",
                    _structure.UUID,
                    mySeq);
                return;
            }
        ...
        public void MoveDown(Colony colony)
        {
            ...
            {
                Log.Info(
                    "MoveDown: blocked â€” CC must stay at top, structure={0}",
                    _structure.UUID);
                return;
            }
            ...
            {
                Log.Info(
                    "MoveDown: blocked â€” already at bottom (seq={0}), structure={1}",
                    mySeq,
                    _structure.UUID);
                return;
            }
