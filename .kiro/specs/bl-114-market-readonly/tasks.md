...
- [x] 1. DTO request models and PlayerContext accessor
  - [x] 1.1 Create MarketListingCreateRequest DTO
  ...
  - [x] 1.2 Create MarketListingUpdateRequest DTO
    - Create OE2EmpireTracker/Models/MarketListingUpdateRequest.cs
    - Properties: ItemName (string), ItemType (ItemType.ItemTypeEnum), ItemReferenceID (string), StationUUID (string), Quantity (int), PricePerUnit (decimal), CurrentHP (int), MaxHP (int), MaxRepairPercent (decimal)
    - Add Compile Include to OE2EmpireTracker.csproj
    - _Requirements: 5.1_

  - [x] 1.3 Add FindMutableMarketListing internal method to PlayerContext
...
- [x] 2. Create MarketListingService with CRUD methods
  - [x] 2.1 Create MarketListingService class
...
- [x] 3. Checkpoint --- Verify new classes compile cleanly
  - Build with zero errors and zero warnings
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Migrate FormListingEdit to use ReadOnly input
  - [x] 4.1 Modify FormListingEdit constructor and behavior
...
- [x] 5. Migrate FormRecordSale to use ReadOnly input
  - [x] 5.1 Modify FormRecordSale constructor
...
- [x] 6. Migrate FormMarket to ReadOnly wrappers and service
  - [x] 6.1 Replace mutable entity references with ReadOnly wrappers in listings grid
  ...
  - [x] 6.2 Replace mutable entity references with ReadOnly wrappers in transactions grid
  ...
  - [x] 6.3 Wire Add button through service
  ...
  - [x] 6.4 Wire Edit button through service
  ...
  - [x] 6.5 Wire Delete button through service with reference protection
  ...
  - [x] 6.6 Wire Record Sale button through service
  ...
  - [x] 6.7 Add MarketListingService field to FormMarket
...
- [x] 7. Checkpoint --- Verify form migration compiles and existing tests pass
  ...
  - Ensure all tests pass, ask the user if questions arise.
- [x] 8. Add Service property tests
  - [x] 8.1 Write property test: CreateListing round-trip
  ...
  - [x] 8.2 Write property test: UpdateListing round-trip
    - Create ValidMarketListingGen() generator producing random MarketListing entities
    - **Property 2: UpdateListing Round-Trip**
    - [FsCheck.NUnit.Property(MaxTest = 25)]
    - **Validates: Requirements 5.3, 5.7**

  - [x] 8.3 Write property test: DeleteListing removes listing
    - **Property 3: DeleteListing Removes Listing**
    - [FsCheck.NUnit.Property(MaxTest = 25)]
    - **Validates: Requirements 6.2**

  - [x] 8.4 Write property test: RecordSale decrements quantity and creates transaction
    - **Property 4: RecordSale Decrements Quantity**
    - [FsCheck.NUnit.Property(MaxTest = 50)]
    - **Validates: Requirements 7.3, 7.4, 7.8**

- [x] 9. Add Service unit tests
  - [x] 9.1 Write unit tests for MarketListingService
...
- [x] 10. Add mutation guard test
  - [x] 10.1 Write mutation guard test for MarketListing
...
- [x] 11. Final checkpoint --- Full build, all tests pass, audit clean
  - Build with zero errors and zero warnings
