...
- [x] 1. DTO request models and PlayerContext accessors
  - [x] 1.1 Create SupplyChainUpdateRequest and SupplyChainCreateRequest DTOs
    - Add Compile Include to OE2EmpireTracker.csproj
    - _Requirements: 7.1, 7.2_
  - [x] 1.2 Add FindMutableSupplyChain internal method to PlayerContext
    - _Requirements: 8.1_

- [x] 2. Create SupplyChainViewModel as disconnected edit buffer
  - [x] 2.1 Create SupplyChainViewModel class
...
- [x] 3. Create SupplyChainMutationService with CRUD methods
  - [x] 3.1 Create SupplyChainMutationService class
...
- [x] 5. Migrate FormSupplyChain to ReadOnly wrappers and service
...
- [x] 8. Add ViewModel property tests
  - [x] 8.1 Write property tests for SupplyChainViewModel
