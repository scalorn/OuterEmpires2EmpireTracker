...
- [x] 5. Batch 4 — Move Baseline/ persistence → Persistence/ (3 files, main project)
  ...
  - [x] 5.2 Verify Batch 4 — build and test
    - Run `getDiagnostics` on all moved files and files with updated usings
    - Build: `msbuild OE2EmpireTracker.sln /p:Configuration=Debug`
    - Test: `vstest.console` against test DLL
    - Verify 746 tests pass
...
- [x] 6. Checkpoint — Main project restructure complete
...
- [-] 7. Batch 5 — Test project restructure (mirror all moves)
  ...
  - [x] 7.2 Move 8 Baseline/ model-test files to Models/ in test project
  ...
  - [x] 7.3 Move 10 Baseline/ service-test files to Services/ in test project
  ...
  - [x] 7.4 Move 2 Baseline/ parser-test files to Parsers/ in test project
  ...
  - [x] 7.5 Move 2 Baseline/ persistence-test files to Persistence/ in test project
