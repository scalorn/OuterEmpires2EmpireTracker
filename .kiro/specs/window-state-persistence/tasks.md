...
- [ ] 1. Create data model classes
  - [ ] 1.1 Create `OE2EmpireTracker/Baseline/UIPreferences.cs` with all data model classes: `UIPreferences`, `WindowPosition`, `WindowState`, `FormControlState`, `ComboState`, `GridState`, `GridColumnState`
  ...
  - [ ]* 1.2 Write unit tests for UIPreferences data model round-trip serialization
...
- [ ] 2. Implement BoundsValidator
  - [ ] 2.1 Create `OE2EmpireTracker/Baseline/BoundsValidator.cs` with static methods `ValidateMainWindowBounds` and `ValidateMdiChildBounds`
  ...
  - [ ]* 2.2 Write unit tests for BoundsValidator
...
- [ ] 3. Checkpoint - Verify data models and validator compile
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Implement PreferencesStore
  - [ ] 4.1 Create `OE2EmpireTracker/Baseline/PreferencesStore.cs` as a singleton
  ...
  - [ ]* 4.2 Write unit tests for PreferencesStore
...
- [ ] 5. Implement WindowStateHelper
  - [ ] 5.1 Create `OE2EmpireTracker/Baseline/WindowStateHelper.cs` as a static class
...
- [ ] 6. Checkpoint - Verify all foundation classes compile
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Integrate MainWindow
  - [ ] 7.1 Add window numbering and `OpenMdiChild<T>()` to `MainWindow.cs`
  ...
  - [ ] 7.2 Add MainWindow save/restore position
...
- [ ] 8. Integrate MDI child forms
  - [ ] 8.1 Add `WindowStateHelper.SaveState` call to `FormColony.OnFormClosed`
  ...
  - [ ] 8.2 Add `WindowStateHelper.SaveState` call to `FormBlueprint.OnFormClosed`
    - Insert `WindowStateHelper.SaveState(this, this.GetType().Name, (int)this.Tag);` before existing cleanup in `OnFormClosed`
    - _Requirements: 4.1, 6.1, 7.1, 8.1, 9.2, 10.2, 12.1_

  - [ ] 8.3 Add `WindowStateHelper.SaveState` call to `FormSurvey.OnFormClosed`
    - Insert `WindowStateHelper.SaveState(this, this.GetType().Name, (int)this.Tag);` before existing cleanup in `OnFormClosed`
    - _Requirements: 4.1, 6.1, 7.1, 8.1, 9.2, 10.2, 12.1_

  - [ ] 8.4 Add `WindowStateHelper.SaveState` call to `FormPlayerProfile.OnFormClosed`
    - Insert `WindowStateHelper.SaveState(this, this.GetType().Name, (int)this.Tag);` before existing cleanup in `OnFormClosed`
    - _Requirements: 4.1, 6.1, 7.1, 8.1, 9.2, 10.2, 12.1_

  - [ ] 8.5 Add `WindowStateHelper.SaveState` call to `FormDeliveryRoute.OnFormClosed`
    - Insert `WindowStateHelper.SaveState(this, this.GetType().Name, (int)this.Tag);` before existing cleanup in `OnFormClosed`
    - _Requirements: 4.1, 6.1, 7.1, 8.1, 9.2, 10.2, 12.1_

  - [ ] 8.6 Add `WindowStateHelper.SaveState` call to `FormDeliveryExecution.OnFormClosed`
    - Insert `WindowStateHelper.SaveState(this, this.GetType().Name, (int)this.Tag);` before existing cleanup in `OnFormClosed`
    - _Requirements: 4.1, 6.1, 7.1, 8.1, 9.2, 10.2, 12.1_

  - [ ] 8.7 Add `WindowStateHelper.SaveState` call to `FormColonyDailyBuild.OnFormClosed`
    - Insert `WindowStateHelper.SaveState(this, this.GetType().Name, (int)this.Tag);` before existing cleanup in `OnFormClosed`
    - _Requirements: 4.1, 6.1, 7.1, 8.1, 9.2, 10.2, 12.1_

  - [ ] 8.8 Add `WindowStateHelper.SaveState` call to `FormColonyActivity.OnFormClosed`
    - Insert `WindowStateHelper.SaveState(this, this.GetType().Name, (int)this.Tag);` before existing cleanup in `OnFormClosed`
    - _Requirements: 4.1, 6.1, 7.1, 8.1, 9.2, 10.2, 12.1_
