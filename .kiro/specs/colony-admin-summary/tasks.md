...
- [x] 1. Create ColonyAdminReportBuilder service with core structure
  - [x] 1.1 Create `OE2EmpireTracker/Services/ColonyAdminReportBuilder.cs` with the `BuildReport(Colony, PlayerContext)` static method
  ...
  - [x] 1.2 Implement Building section rendering
  ...
  - [x] 1.3 Implement Commodity Requests section rendering
  ...
  - [x] 1.4 Implement Inactivity section rendering
  ...
  - [x] 1.5 Implement Activity section rendering — non-repeating rows (Manufacturing, CommodityManufacturing, Research)
...
- [x] 2. Implement batch completion time calculation for manufacturing
  - [x] 2.1 Iterate colony structures directly for Manufacturing and CommodityManufacturing with `ManufacturingQuantity > 1`
  ...
  - [x] 2.2 Write property test for batch completion (Property 8)
...
- [x] 3. Implement mining and refining aggregation
  - [x] 3.1 Implement mining aggregation in the report builder
  ...
  - [x] 3.2 Implement refining aggregation in the report builder
  ...
  - [x] 3.3 Write property test for mining aggregation (Property 9)
  ...
  - [x] 3.4 Write property test for refining aggregation (Property 10)
...
- [x] 5. Wire up FormColony UI — RichTextBox and Timer on Administration tab
  - [x] 5.1 Add `RichTextBox rtbAdminReport` and `Timer timerAdminRefresh` to FormColony
  ...
  - [x] 5.2 Implement `RefreshAdminReport()` and wire refresh triggers
...
- [x] 7. Write property tests for report structure and ordering
  - [x] 7.1 Write property test for section ordering (Property 1)
  ...
  - [x] 7.2 Write property test for completion time dual display (Property 2)
  ...
  - [x] 7.3 Write property test for building sort order (Property 3)
  ...
  - [x] 7.4 Write property test for inactivity group ordering (Property 4)
  ...
  - [x] 7.5 Write property test for inactivity content (Property 5)
  ...
  - [x] 7.6 Write property test for activity excludes building (Property 6)
  ...
  - [x] 7.7 Write property test for activity sort order (Property 7)
  ...
  - [x] 7.8 Write property test for commodity request content (Property 11)
