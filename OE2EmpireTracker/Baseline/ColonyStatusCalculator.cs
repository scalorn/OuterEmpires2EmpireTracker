...
namespace OE2EmpireTracker.Baseline
{
    ...
    public class ColonyStatusCalculator
    {
        ...
        public void populateStatus(RichTextBox rtbStatus)
        {
            ...
            // --- Power Status ---
            UpdateStatus(rtbStatus, "Power:", Color.Black, PowerRequired, PowerProvided);

            // --- Habitation Status ---
            UpdateStatus(rtbStatus, " Habitation: ",
                ((HabitationProvision < HabitationRequired) ? Color.Red : Color.Green), // Simplified logic check based on property names below
                HabitationRequired, HabitationProvision);

            // --- Food Status ---
            UpdateStatus(rtbStatus, " Food: ",
                FoodProvision < FoodRequired ? Color.Red : Color.Green,
                FoodRequired, FoodProvision);

            // --- Entertainment Status ---
            UpdateStatus(rtbStatus, " Entertainment: ",
                EntertainmentProvided < EntertainmentRequired ? Color.Red : Color.Green,
                EntertainmentRequired, EntertainmentProvided);

            // --- Warehouse Status ---
            UpdateStatus(rtbStatus, " Warehouse: ",
                WarehouseCapacity < WarehouseRequired ? Color.Red : Color.Green,
                WarehouseRequired, WarehouseCapacity);
        }
