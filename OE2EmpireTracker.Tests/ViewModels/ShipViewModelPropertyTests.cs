...
{
    /// <summary>
    /// Property-based tests for ShipViewModel edit buffer.
    /// Feature: bl-116-ship-readonly
    /// </summary>
    [TestFixture]
    public class ShipViewModelPropertyTests
    {
        ...
        private static Gen<Ship> ValidShipGen()
        {
        ...
        private static Gen<Ship> ValidShipWithComponentsGen()
        {
            return from name in SafeStringGen()
                   from hullUUID in SafeStringGen()
        ...
        {
            return Prop.ForAll(ValidShipGen().ToArbitrary(), template =>
            {
        ...
        public Property IsDirty_DetectsComponentsChange()
        {
            ...
            return Prop.ForAll(
                ValidShipWithComponentsGen().ToArbitrary(),
