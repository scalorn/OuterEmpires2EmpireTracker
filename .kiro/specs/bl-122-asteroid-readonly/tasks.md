...
- [ ] 1. DTO request models and PlayerContext accessors
  - [ ] 1.1 Create AsteroidUpdateRequest and AsteroidCreateRequest DTOs
    - Add Compile Include to OE2EmpireTracker.csproj
    - _Requirements: 7.1, 7.2_
  - [ ] 1.2 Add FindMutableAsteroid internal method to PlayerContext
    - _Requirements: 8.1_

- [ ] 2. Create AsteroidViewModel as disconnected edit buffer
  - [ ] 2.1 Create AsteroidViewModel class
...
- [ ] 3. Create AsteroidService with CRUD methods
  - [ ] 3.1 Create AsteroidService class
...
- [ ] 5. Migrate FormAsteroid to ReadOnly wrappers and service
...
- [ ] 8. Add ViewModel property tests
  - [ ] 8.1 Write property tests for AsteroidViewModel
