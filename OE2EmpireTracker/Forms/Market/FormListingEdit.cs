...
namespace OE2EmpireTracker.Forms.Market
{
    public class FormListingEdit : Form
    {
        ...
        public FormListingEdit(MarketListing listing, PlayerContext playerContext)
        {
            ...
            int y = 10;
            AddLabel("Item Name:", 10, y); txtItemName = AddTextBox(120, y, 230); y += 30;
            AddLabel("Type:", 10, y);
            ...
            AddLabel("Quantity:", 10, y); txtQuantity = AddTextBox(120, y, 100); y += 30;
            AddLabel("Price/Unit:", 10, y); txtPricePerUnit = AddTextBox(120, y, 100); y += 30;
            AddLabel("Current HP:", 10, y); txtCurrentHP = AddTextBox(120, y, 100); y += 30;
            AddLabel("Max HP:", 10, y); txtMaxHP = AddTextBox(120, y, 100); y += 30;
            ...
            for (int i = 0; i < cmbItemType.Items.Count; i++)
                if (cmbItemType.Items[i] is ItemType.ItemTypeEnum t2 && t2 == listing.ItemType) { cmbItemType.SelectedIndex = i; break; }
            for (int i = 0; i < cmbStation.Items.Count; i++)
                if (cmbStation.Items[i] is StationItem si && si.UUID == listing.StationUUID) { cmbStation.SelectedIndex = i; break; }
