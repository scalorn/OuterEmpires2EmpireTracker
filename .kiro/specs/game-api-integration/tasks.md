...
- [ ] 5. Implement GameApiSyncScheduler and profile merge
  - [-] 5.1 Implement GameApiSyncScheduler - timer and round-robin
  ...
  - [~] 5.2 Implement Player Profile merge logic and DTO
...
- [ ] 6. Implement GameApiContext singleton and wire into Program.cs
  - [~] 6.1 Implement GameApiContext singleton
  ...
  - [~] 6.2 Wire GameApiContext initialization into Program.cs and handle HTTP 401
...
- [ ] 7. Add Game API UI integration
  - [~] 7.1 Add Game API tab to Preferences form
  ...
  - [~] 7.2 Add Game API status to MainWindow status bar
...
- [ ] 8. Tests - Credential Manager and Settings
  - [~] 8.1 Tests - GameApiCredentialManager (Property: Credential Isolation)
