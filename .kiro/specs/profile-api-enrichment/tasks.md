...
- [ ] 1. Model layer changes
  ...
  - [-] 1.2 Rename PlayerRank properties and add RankName
  ...
  - [-] 1.3 Add metadata and training progress properties to PlayerSkill
...
- [ ] 2. PlayerRankJsonConverter for backward-compatible deserialization
  - [~] 2.1 Create PlayerRankJsonConverter class
...
- [ ] 3. DTO changes
  - [~] 3.1 Add fields to GameApiProfileResponse and GameApiRankResponse
  ...
  - [~] 3.2 Add fields to GameApiSkillResponse and create GameApiSkillInTrainingResponse
...
- [ ] 4. Merge logic changes in GameApiSyncScheduler
  - [~] 4.1 Extend MergeProfileData for new scalar fields
  ...
  - [~] 4.2 Update MergeRank for renamed properties and new fields
  ...
  - [~] 4.3 Extend MergeSkills for metadata fields
  ...
  - [~] 4.4 Extend MergeSkills for training progress
...
- [ ] 6. ReadOnly wrapper updates
  - [~] 6.1 Update ReadOnlyPlayerRank with renamed properties
  ...
  - [~] 6.2 Add new properties to ReadOnlyPlayerProfile and ReadOnlyPlayerSkill
...
- [ ] 7. ViewModel and edit buffer changes
  - [~] 7.1 Rename LocalRankData properties
    - Rename Title → RankName, CurrentXP → CurrentXp, NextXP → XpToNextLevel
    - _Requirements: 13.1, 13.2, 13.3_
    - _Files: OE2EmpireTracker.Common/ViewModels/LocalRankData.cs_

  - [~] 7.2 Add metadata properties to LocalSkillData
  ...
  - [~] 7.3 Update PlayerProfileViewModel for renamed rank properties
  ...
  - [~] 7.4 Update PlayerProfileViewModel to copy skill metadata into LocalSkillData
...
- [ ] 8. PlayerProfileService changes
  - [~] 8.1 Rename ApplyRank parameters and update request DTOs
...
- [ ] 9. Consumer renames — non-UI code
  - [~] 9.1 Update PlayerProfileParser for renamed properties
  ...
  - [~] 9.2 Update PlayerProfileEndpoints for renamed properties
    - Replace all references to Title → RankName, CurrentXP → CurrentXp, NextXP → XpToNextLevel
...
- [ ] 11. UI changes — FormPlayerProfile rank labels
  - [~] 11.1 Add rank name labels to FormPlayerProfile Designer
  ...
  - [~] 11.2 Wire rank name labels in FormPlayerProfile code-behind
...
- [ ] 12. UI changes — PlayerSkillBlock metadata display
  - [~] 12.1 Add metadata labels to PlayerSkillBlock Designer
  ...
  - [~] 12.2 Wire metadata display in PlayerSkillBlock code-behind
...
- [ ] 14. Tests — PlayerRankJsonConverter
  - [~] 14.1 Write unit tests for PlayerRankJsonConverter
...
- [ ] 15. Tests — Merge logic
  - [~] 15.1 Write unit tests for MergeProfileData new fields
  ...
  - [~] 15.2 Write unit tests for MergeRank with new fields
  ...
  - [~] 15.3 Write unit tests for MergeSkills metadata and training progress
...
- [ ] 16. Tests — Backward compatibility and consumer renames
  - [~] 16.1 Write backward compatibility tests for PlayerData.json loading
  ...
  - [~] 16.2 Update existing test references from old to new property names
