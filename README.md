...
### Ship Templates
Design reusable ship configurations. Open from **Manage → Ship Templates**. Pick a hull, then fill component slots (reactors, drives, weapons, cargo pods, shields, etc.) from your blueprint collection. Each slot has a filtered combo box — type part of a blueprint name to narrow the list instantly. The stats panel updates live as you install components — see mass, power balance, cargo capacity, defence ratings, and propulsion at a glance. Select a pricing plan to see the total estimated build cost — the price sums hull and all component blueprint costs using your plan's resource prices and time-cost parameters, updating live as you swap parts. When you're ready to build, click Order Build to generate manufacturing items for the hull and every component, feeding directly into the Build Planner.
