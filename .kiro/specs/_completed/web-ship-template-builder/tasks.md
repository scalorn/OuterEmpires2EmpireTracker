...
- [x] 1. Implement slot type constants and mappings
  ...
  - [x] 1.2 Write unit tests for slot type mappings
  ...
  - [x] 1.3 Write property test for slot generation (Property 9)
...
- [x] 2. Implement stats computation pure function
  ...
  - [x] 2.2 Write unit tests for `computeShipStats`
  ...
  - [x] 2.3 Write property test: pure function determinism (Property 1)
  ...
  - [x] 2.4 Write property test: additive commutativity (Property 2)
    - **Property 2: Additive properties are commutative**
    - **Validates: Requirements 9.2**
  - [x] 2.5 Write property test: ScanLevel maximum (Property 3)
    - **Property 3: ScanLevel uses maximum, not sum**
    - **Validates: Requirements 9.3**
  - [x] 2.6 Write property test: engineering capacity separation (Property 4)
    - **Property 4: Engineering capacity separates hull from components**
    - **Validates: Requirements 9.4**
  - [x] 2.7 Write property test: derived stats consistency (Property 5)
    - **Property 5: Derived stats are consistent with raw stats**
    - **Validates: Requirements 5.4, 9.7**
  - [x] 2.8 Write property test: shield uptime infinite (Property 6)
    - **Property 6: Shield uptime infinite when draw ≤ regen**
    - **Validates: Requirements 5.4**
  - [x] 2.9 Write property test: weapon sustain infinite (Property 7)
    - **Property 7: Weapon sustain time infinite when draw ≤ regen**
    - **Validates: Requirements 5.4**
  - [x] 2.10 Write property test: missing properties default to zero (Property 12)
    - **Property 12: Missing properties default to zero**
    - **Validates: Requirements 9.2**

- [x] 3. Implement URL codec
  ...
  - [x] 3.2 Write unit tests for URL codec
  ...
  - [x] 3.3 Write property test: URL encode/decode round-trip (Property 11)
...
- [x] 5. Implement Zustand store
  - [x] 5.1 Create `shipBuilderStore.ts` with state management
  ...
  - [x] 5.2 Write unit tests for the Zustand store
  ...
  - [x] 5.3 Write property test: blueprint cache prevents redundant fetches (Property 8)
    - **Property 8: Blueprint cache prevents redundant fetches**
    - **Validates: Requirements 6.2, 6.3**
  - [x] 5.4 Write property test: component filtering respects slot type AND class (Property 10)
...
- [x] 7. Implement UI components - Hull selection and slot display
  - [x] 7.1 Create `HullSelector.tsx` component
  ...
  - [x] 7.2 Create `SlotGrid.tsx`, `SlotGroup.tsx`, and `SlotItem.tsx` components
...
- [x] 8. Implement UI components - Stats display
  - [x] 8.1 Create `ShipStatsDisplay.tsx` component
...
- [x] 9. Implement page component and routing
  - [x] 9.1 Create `ShipBuilder.tsx` main page component
  ...
  - [x] 9.2 Add route and navigation entry
